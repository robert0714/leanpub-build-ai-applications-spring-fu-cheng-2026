...
public class ImageAnalysisController {
    ...
    /***
     * https://docs.spring.io/spring-ai/reference/api/chat/ollama-chat.html<p>
     * https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-ollama/src/test/java/org/springframework/ai/ollama/OllamaChatModelMultimodalIT.java
     * 
    */
    private final OllamaChatModel chatModel;

    public ImageAnalysisController(OllamaChatModel chatModel) {
