...
* Command: `java` 
* Arguments: `-jar D:/Data/workspaces/STS-5.0.x/leanpub-build-ai-applications-spring-fu-cheng-2026/ch14/file-system-mcp-server/target/file-system-mcp-server-0.0.1-SNAPSHOT.jar`
    ...
    ```json
    {
      "mcpServers": {
        "my-custom-server": {
          ...
          "args": [
            "-jar",  
            "D:/Data/workspaces/STS-5.0.x/leanpub-build-ai-applications-spring-fu-cheng-2026/ch14/file-system-mcp-server/target/file-system-mcp-server-0.0.1-SNAPSHOT.jar"
          ]
        }
      }
    }
